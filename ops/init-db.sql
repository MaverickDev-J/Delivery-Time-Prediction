...
-- (DB-per-service pattern — each service owns its own schema)
...
GRANT ALL PRIVILEGES ON DATABASE auth_db TO deliveriq;
GRANT ALL PRIVILEGES ON DATABASE webhook_db TO deliveriq;
